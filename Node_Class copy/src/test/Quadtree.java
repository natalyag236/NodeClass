...
class Quadtree {
     ...
     */
    @Test
    public void testInsert_Find() {
        Rectangle rect = new Rectangle(-20, -20, 15, 15);  
        root.insert(rect);
    ...
    /**
     * Tests updates the rectangle's dimensions and verifies that the update was successful.
     ...
     */
    @Test
    public void test_complex_operations() {
